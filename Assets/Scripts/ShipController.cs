...
public class ShipController : MonoBehaviour
{
    ...
    [SerializeField] float _waterForwardDamping = 0.7f;
    [SerializeField] float _waterSideDamping = 0.1f;
    [SerializeField] float _airForwardDamping = 0.1f;
    [SerializeField] float _airSideDamping = 0.05f;
